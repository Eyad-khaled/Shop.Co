    ...
    <div id="nav"  className="fixed top-0 left-0 w-full z-50 bg-white shadow-lg">
      ...
      >
        <div className="flex justify-center items-center gap-2">
          ...
          <Link href="/">
            <h1 className="font-[700] text-2xl">Shop.Co</h1>
          </Link>
        </div>
        <ul className="sm:flex hidden items-center gap-6 text-md font-[500] ">
          ...
          >
            ...
            >
              <h1>Categories</h1>
              <div
                className={` ${isCategoriesOpen ? "rotate-180" : ""} transition duration-300 ease-in-out`}
              >
        ...
        <div className="icons flex items-center gap-4">
          ...
          >
            <div className="p-4 flex flex-col gap-4 bg-white rounded-md">
              <p>
                To view your cart, please log in or sign up for an account. This
                will allow you to save your cart and access it from any device.
